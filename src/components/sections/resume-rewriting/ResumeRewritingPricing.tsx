...
> = {
  entry: {
    bestFor: "Students, graduates & early-career professionals",
    features: [
      "Full review of your existing resume",
      "Complete rewrite with stronger content",
      "Modern ATS-friendly formatting",
      "Keyword alignment for entry-level roles",
      "Word & PDF delivery",
      "Revisions included",
    ],
  },
  mid: {
    bestFor: "Professionals ready for growth and better roles",
    popular: true,
    features: [
      "Full review of your existing resume",
      "Complete rewrite with results-focused content",
      "Modern ATS-friendly formatting",
      "Keyword alignment for mid-level roles",
      "One-on-one consultation",
      "Word & PDF delivery + revisions",
    ],
  },
  executive: {
    bestFor: "Managers, directors & executive candidates",
    features: [
      "Full executive-level resume review",
      "Strategic rewrite for leadership roles",
      "Modern ATS-friendly formatting",
      "Keyword alignment for senior roles",
      "One-on-one consultation",
      "Word & PDF delivery + revisions",
    ],
  },
...
export function ResumeRewritingPricing() {
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8 md:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-heading tracking-tight text-foreground mb-2">
            ...
            <span className="text-primary">Resume Revamp Services</span>
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Choose the level that matches your experience. Resume-only revamp
            pricing shown below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`rr-pricing-card relative rounded-3xl border ${
                  meta.popular
              ...
              >
                ...
                <div className="p-6 pt-0">
                  <Link
                    href={`/checkout?plan=${plan.id}&pkg=resume&intent=revamp`}
