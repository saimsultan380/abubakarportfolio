  ...
  return (
    ...
    >
      <div className="absolute top-1/2 -translate-y-1/2 left-0 w-full opacity-[0.03] pointer-events-none select-none">
        ...
        >
          <span className="px-4">Get Hired in USA</span>
          <span className="px-4">Get Hired in USA</span>
          <span className="px-4">Get Hired in USA</span>
          <span className="px-4">Get Hired in USA</span>
        </div>
      ...
      <div className="container px-4 mx-auto relative z-10 usa-cta-content">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-bold font-heading tracking-tighter mb-6 text-foreground">
            Stop Getting Ignored by{" "}
            <span className="text-primary">US Recruiters</span>
          </h2>

          <p className="text-lg md:text-xl text-muted-foreground font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
            Get an ATS-compliant resume or CV built to put you in the top 1% of
            applicants across the USA. Your next interview call starts with a
            resume that actually gets read.
          </p>
