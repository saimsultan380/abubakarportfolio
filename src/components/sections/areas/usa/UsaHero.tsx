        ...
        <div className="flex flex-col items-center text-center">
          <div ref={contentRef} className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground font-heading mb-4 leading-[1.1]">
              ATS Resume Writing Service in the USA:{" "}
              <span className="text-primary">Get Hired Fast in USA</span>
            </h1>

            <p className="text-sm sm:text-base text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
              Professional ATS-friendly Resume Writing services by certified ATS
              resume writers in the USA. Resume Uplift optimizes your ATS resume
              and increases your chances of being hired and receiving interview
              calls in the USA marketplace.
            </p>

            <p className="text-sm sm:text-base font-semibold text-foreground/85 mb-7 max-w-2xl mx-auto">
              Join the 90% of candidates who secured jobs after using our ATS
              resume writing services in the USA.
            </p>
