...
const highlights = [
  ...
  "Written by Certified ATS Resume Writers in the UK",
  "Approved by Global HR Experts in the UK",
  "One-on-One Consultation & Evaluation Included",
  "Free ATS Resume Templates for Every Client in the UK",
  "Unlimited Revisions Until You're 100% Satisfied",
];

export function UkTrusted() {
  return (
