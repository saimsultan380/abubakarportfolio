        ...
        <div className="flex flex-col items-center text-center">
          <div ref={contentRef} className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground font-heading mb-4 leading-[1.1]">
              Get #1 ATS-Friendly Resume &amp; CV Writing Services in the{" "}
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
              Most resumes and CVs never reach a human. They&apos;re filtered
              out by ATS software before a recruiter opens the file, often
              because of formatting the applicant never thought to check.
              Resume Uplift builds resumes that pass UK employer screening
              systems and still read well once a person picks them up.
            </p>

            <p className="text-sm sm:text-base font-semibold text-foreground/85 mb-7 max-w-2xl mx-auto">
              Get your resume reviewed for ATS compatibility today!
            </p>
