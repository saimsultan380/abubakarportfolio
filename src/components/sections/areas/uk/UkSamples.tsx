        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-heading tracking-tight text-foreground mb-4">
              ...
              <span className="text-primary">UK Audience</span>
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6">
              Browse ATS-optimised resume and CV samples built for UK hiring
              systems — clear section headings, clean formatting, and
              advert-matched wording that works for both software and recruiters.
            </p>
            <Link
              href="/samples"
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl border border-border/70 bg-muted/30 shadow-sm">
            <Image
              src="/areas/uk-ats-templates-samples.png"
              alt="ATS-friendly resume and CV writing templates for the UK audience"
              fill
