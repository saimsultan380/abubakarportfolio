...
const services = [
  ...
  },
  {
    ...
    description:
      "Many New Zealand recruiters search LinkedIn directly instead of waiting for applications to come in. We optimize your headline, summary, and experience sections so you show up in those searches.",
  ...
  },
  {
    ...
    description:
      "Switching industries, moving from individual contributor to management, or targeting a niche field. Your resume gets written around the expectations of that specific path, not a generic template.",
    href: "/career-specific-cv",
    icon: Briefcase,
  },
];

export function NzOtherServices() {
  return (
