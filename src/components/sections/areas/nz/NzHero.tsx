        ...
        <div className="flex flex-col items-center text-center">
          <div ref={contentRef} className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground font-heading mb-4 leading-[1.1]">
              Top ATS-friendly Resume or CV Writing Services in{" "}
              <span className="text-primary">New Zealand</span>
            </h1>

            <p className="text-sm sm:text-base font-semibold text-foreground/85 mb-3 max-w-2xl mx-auto">
              Your resume might be getting rejected before a human ever opens
              it.
            </p>

            <p className="text-sm sm:text-base text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
              Most mid-size and large New Zealand companies now screen
              applications through an Applicant Tracking System before a
              recruiter sees them. If your formatting or keywords are off, a
              qualified resume can get filtered out in seconds, no matter how
              strong your background is.
            </p>

            <p className="text-sm sm:text-base text-muted-foreground mb-7 max-w-3xl mx-auto leading-relaxed">
              Resume Uplift writes ATS-friendly resumes and CVs built for
              exactly how New Zealand hiring software reads and ranks
              candidates.
            </p>
