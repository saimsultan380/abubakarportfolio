...
const highlights = [
  ...
  "Written by Certified ATS Resume Writers in New Zealand",
  "Approved by Global HR Experts",
  "One-on-One Consultation & Evaluation Included",
  "Free ATS Resume Templates for Every New Zealand Client",
  "Unlimited Revisions Until You're 100% Satisfied",
];

export function NzTrusted() {
  return (
      ...
      <div className="container mx-auto px-5 sm:px-6 md:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-6 max-w-2xl text-sm md:text-base text-muted-foreground leading-relaxed">
            Rated by thousands of professionals across New Zealand for reliable
